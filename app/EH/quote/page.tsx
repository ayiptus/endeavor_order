...
export default function QuotePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("There was an error sending your quote request. Please try again or contact support.")
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-700 mb-3">
                    ...
                    may be necessary to confirm the scope and generate an official quotation.
                  </p>
