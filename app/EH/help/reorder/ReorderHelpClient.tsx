...
export default function ReorderHelpClient() {
      ...
      <section className="py-12 px-4 md:px-8">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <Card className="p-8">
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <Image
                src="/images/09-eh-helpasset-6.png"
          ...
          <Card className="p-8">
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <Image
                src="/images/10-eh-helpasset-16.png"
          ...
          <Card className="p-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">11. Select your Order and Add Comments</h2>
            <p className="text-slate-700 leading-relaxed mb-6">
              Using the details window, identify the signs you wish to reorder by selecting the green check mark. Leave
              us a comment regarding any changes to messaging, graphics and how you want the new sign to look. Review
              the sign type, quantity, branding, attachment method, and finish specifications.
            </p>
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <Image
                src="/images/11-eh-helpasset-15.png"
          ...
          <Card className="p-8">
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <Image
                src="/images/12-eh-helpasset-3.png"
          ...
          <Card className="p-8">
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <Image
                src="/images/13-eh-helpasset-2.png"
          ...
          <Card className="p-8">
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <Image
                src="/images/14-eh-helpasset-14.png"
